        ...
        <div class="md:flex w-full">
          ...
          <div class="w-full md:w-1/2 py-10 px-2 md:px-10">
            ...
            <div>
              ...
              <div class="flex -mx-3">
                <div class="w-full px-3 mb-5">
                  ...
                  <div class="flex">
                    ...
                    >
                      <i
                        class="mdi mdi-phone-outline text-gray-400 text-lg"
                      ></i>
                    </div>
                    <input
                ...
                <div class="w-full px-3 mb-5">
                  ...
                  <div class="flex">
                    <div
                      ...
                      "
                    >
                      <i class="mdi mdi-account-key text-gray-400 text-lg"></i>
                    </div>
                    <input
                      type="text"
              ...
              <div
                class="flex p-2 bg-red-100 mt-2 rounded"
                v-show="error != ''"
              >
                {{ error }}
              </div>
              <div class="flex -mx-3">
                <div class="w-full px-3 mb-5 mt-8">
                  <button
                    class="
                      block
                      w-full
              ...
              <div class="text-center mb-10">
                <p>
                  have account
                  <a @click="login" class="text-indigo-500 cursor-pointer"
                    >login here</a
                  >
                </p>
              </div>
